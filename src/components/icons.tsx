...
export const IconBack = ({ className, size, strokeWidth }: IconProps) => (
  <svg className={className} {...baseProps(size, strokeWidth)}>
    <path d="M14 6l-6 6 6 6" />
  </svg>
)

export const IconClose = ({ className, size, strokeWidth }: IconProps) => (
  <svg className={className} {...baseProps(size, strokeWidth)}>
    <path d="M6 6l12 12M18 6L6 18" />
  </svg>
)

export const IconEmail = ({ className, size, strokeWidth }: IconProps) => (
  <svg className={className} {...baseProps(size, strokeWidth)}>
...
export const IconEye = ({ className, size, strokeWidth }: IconProps) => (
  <svg className={className} {...baseProps(size, strokeWidth)}>
...
export const IconEyeOff = ({ className, size, strokeWidth }: IconProps) => (
  <svg className={className} {...baseProps(size, strokeWidth)}>
    <path d="M3 3l18 18" />
...
export const IconBell = ({ className, size, strokeWidth }: IconProps) => (
  <svg className={className} {...baseProps(size, strokeWidth)}>
...
export const IconTrophy = ({ className, size, strokeWidth }: IconProps) => (
  <svg className={className} {...baseProps(size, strokeWidth)}>
...
export const IconQuestion = ({ className, size, strokeWidth }: IconProps) => (
  <svg className={className} {...baseProps(size, strokeWidth)}>
...
export const IconMore = ({ className, size, strokeWidth }: IconProps) => (
  <svg className={className} {...baseProps(size, strokeWidth)}>
...
export const IconProfile = ({ className, size, strokeWidth }: IconProps) => (
  <svg className={className} {...baseProps(size, strokeWidth)}>
...
export const IconDiscover = ({ className, size, strokeWidth }: IconProps) => (
  <svg className={className} {...baseProps(size, strokeWidth)}>
...
export const IconHome = ({ className, size, strokeWidth }: IconProps) => (
  <svg className={className} {...baseProps(size, strokeWidth)}>
    <path d="M4 11l8-7 8 7v9a1 1 0 01-1 1h-4v-6h-6v6H5a1 1 0 01-1-1v-9z" />
  </svg>
)

export const IconSort = ({ className, size, strokeWidth }: IconProps) => (
  <svg className={className} {...baseProps(size, strokeWidth)}>
    <path d="M5 7h14M7 12h10M9 17h6" />
  </svg>
)

export const IconStar = ({ className, size, strokeWidth }: IconProps) => (
  <svg className={className} {...baseProps(size, strokeWidth)}>
    <path d="M12 3l2.7 5.5L21 9.4l-4.5 4.4L17.5 20 12 17l-5.5 3 1-6.2L3 9.4l6.3-.9L12 3z" />
  </svg>
)

export const IconTime = ({ className, size, strokeWidth }: IconProps) => (
  <svg className={className} {...baseProps(size, strokeWidth)}>
...
export const IconHint = ({ className, size, strokeWidth }: IconProps) => (
  <svg className={className} {...baseProps(size, strokeWidth)}>
...
export const IconCheck = ({ className, size, strokeWidth }: IconProps) => (
  <svg className={className} {...baseProps(size, strokeWidth)}>
...
export const IconWrong = ({ className, size, strokeWidth }: IconProps) => (
  <svg className={className} {...baseProps(size, strokeWidth)}>
    <circle cx="12" cy="12" r="9" fill="currentColor" stroke="none" />
...
export const IconShare = ({ className, size, strokeWidth }: IconProps) => (
  <svg className={className} {...baseProps(size, strokeWidth)}>
    <path d="M12 4v12" />
    <path d="M8 8l4-4 4 4" />
...
export const IconSwords = ({ className, size, strokeWidth }: IconProps) => (
  <svg className={className} {...baseProps(size, strokeWidth)}>
...
export const IconUsers = ({ className, size, strokeWidth }: IconProps) => (
  <svg className={className} {...baseProps(size, strokeWidth)}>
...
export const IconMenu = ({ className, size, strokeWidth }: IconProps) => (
  <svg className={className} {...baseProps(size, strokeWidth)}>
