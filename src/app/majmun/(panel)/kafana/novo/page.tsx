...
export default function NovoKafanskoPitanjePage() {
  ...
  async function save(addAnother: boolean) {
    ...
    const { error: e } = await createClient().from('kafana_questions').insert({
    ...
    if (addAnother) reset(); else router.push('/majmun/kafana')
  }
      ...
      <div className="card-soft p-6 sm:p-8 space-y-5">
        ...
        <label className="block">
          ...
          <textarea value={text} onChange={e => setText(e.target.value)} rows={3}
            placeholder="Npr. Ko peva pesmu „Dva smo sveta različita“?"
        ...
        <div className="flex gap-3 pt-2">
          ...
          <button onClick={() => save(true)} disabled={busy} className="btn btn-secondary btn-md">
